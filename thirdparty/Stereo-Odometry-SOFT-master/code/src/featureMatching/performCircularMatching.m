...
matches_1_lr = stereo_match(pts1_l, pts1_r, width, height, false);

matches_2_ll = frame_match(pts1_l, pts2_l, width, height, false);
matches_3_lr = stereo_match(pts2_l, pts2_r, width, height, false);
matches_4_rr = frame_match(pts2_r, pts1_r, width, height, false);

indleft = find(~isnan(matches_2_ll(:,2)));
